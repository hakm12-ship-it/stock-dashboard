...
export const HELP: Record<string, { title: string; text: string }> = {
  ...
  flow: {
    title: '투자자별 매매동향 (수급)',
    text: '하루 동안 외국인·기관·개인이 각각 얼마나 사고팔았는지(순매수 주식 수)예요.\n외국인·기관이 연일 사들이면 수급이 좋다고 보는 경우가 많아요. 빨강=순매수, 파랑=순매도.\n과거 기록일 뿐 미래를 보장하지 않아요.',
  },
  backtest: {
    title: '신호 과거 성과',
    text: '지금과 똑같은 규칙으로 지난 1년의 매일매일 신호를 계산해보고, 매수/매도 우위 신호가 떴던 날로부터 며칠 뒤 실제로 어떻게 됐는지 모은 통계예요.\n적중률 = 매수신호 뒤 올랐거나, 매도신호 뒤 내린 비율.\n표본이 적으면 우연일 수 있고, 과거 성과가 미래 수익을 보장하지 않아요.',
  },
  target: {
    title: '애널리스트 목표주가',
